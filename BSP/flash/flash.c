...
///*flash操作是以32位操作*/
//void FlashWrite(uint32_t addr, uint32_t *buf, uint16_t len)
//{
//	uint16_t i;
//	
//	uint8_t equal_num=0;
...
//	fmc_unlock();								//解锁
//	
//	FlashRead(GD32_FLASH_BASE+page_pos*PAGE_SIZE, page, PAGE_SIZE/4);		//读出页内容	,字读取
//	
//	
//	//检查是否需要擦除
//	for(i=0;i<len;i++)
...
//void FlashRead(uint32_t addr, uint32_t *buf, uint16_t len)
//{
//	uint16_t i=0;
